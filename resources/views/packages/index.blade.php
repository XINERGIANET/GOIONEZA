  		...
  		<form id="storeForm" method="POST">
  			...
  			<div class="modal-body">
  			  <div class="row">
  			  	...
  			  	<div class="col-lg-6">
  			  		<div class="mb-3">
  			  			<label class="form-label required">Precio por persona</label>
  			  	...
  			  	<div class="col-lg-12">
  			  		<div class="mb-3">
  			  			...
  			  			<textarea rows="20" class="form-control" name="description"></textarea>
  			  		</div>
  			  	</div>
  			  </div>
  			</div>
  			...
  			<div class="modal-body">
  			  <div class="row">
  			  	...
  			  	<div class="col-lg-12">
  			  		<div class="mb-3">
  			  			<label class="form-label">Descripción</label>
  			  			<textarea rows="20" class="form-control" name="description" id="editDescription"></textarea>
  			  		</div>
  			  	</div>
  			  </div>
  			</div>
...
<script>
	...
	$(document).on('click', '.btn-edit', function(){
		...
		$.ajax({
			url: '{{ route('packages.index') }}' + '/' + id + '/edit/',
			method: 'GET',
			success: function(data){
