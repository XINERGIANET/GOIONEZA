...
<body class="d-flex flex-column bg-white">
	<div class="row g-0 flex-fill">
	  <div class="col-12 col-lg-6 col-xl-4 border-top-wide border-primary d-flex flex-column justify-content-center">
	    <div class="container container-tight my-5 px-lg-5">
	      <div class="text-center mb-4">
	        <a href="#" class="navbar-brand navbar-brand-autodark"><img src="{{ asset('assets/images/xinergia.png') }}" width="200"></a>
	      </div>
	      ...
	      <form action="{{ route('auth.check') }}" method="POST" autocomplete="off">
	        ...
	        <div class="form-footer">
	          <button type="submit" class="btn btn-red w-100">Iniciar sesión</button>
	        </div>
	      </form>
	  ...
	  <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
	    <div class="h-100 min-vh-100 d-flex align-items-center justify-content-center" style="background-color: #1a2234;">
	    	<img src="{{ asset('assets/images/logonew2.png') }}" class="img-fluid p-6" style="max-height: 80%; object-fit: contain;">
	    </div>
	  </div>
	</div>
